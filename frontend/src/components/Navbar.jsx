  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <Link to='/'><img src = {assets.logo} className='w-36' alt = ""/></Link>
        ...
        {/* Menu Section in the Center by "items-center"*/}
        <div className='flex items-center gap-6'>
          <img src={assets.search_icon} className='w-5 cursor-pointer' alt=""/>

          <div className='group relative'>
          
            <Link to={'/login'}><img onClick={() => setShowSearch(true)} className='w-5 cursor-pointer' src = {assets.profile_icon} alt=""/></Link>
          ...
          {/* Menu Icon for Mobile Screen Resolution. */}
          <img onClick={() => setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden' alt=""></img>
            ...
            {/* A dynamic className means the CSS classes change based on some condition, state, or variable. */}
